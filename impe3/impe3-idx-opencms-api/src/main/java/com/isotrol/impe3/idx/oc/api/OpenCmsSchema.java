package com.isotrol.impe3.idx.oc.api;
 ...
 */
public final class OpenCmsSchema { 

	private OpenCmsSchema() {
	...
	public static final String SCHEMA_NAME = "ocnr-";

	/** Properties reserved schema name. */
	public static final String PROPERTY_PREFIX = SCHEMA_NAME + "ocprop-";
	/** Custom fields reserved schema name. */
	public static final String CUSTOM_PREFIX = SCHEMA_NAME + "occustom-";
