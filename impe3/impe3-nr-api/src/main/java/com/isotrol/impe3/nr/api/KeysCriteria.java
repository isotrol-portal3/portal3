...
/**
 * Keys filter criteria.
 * @see FilterCriteria for a general description of criteria.
 * @author Andres Rodriguez
 */
public final class KeysCriteria extends FilterCriteria<NodeKey> {
	/**
	 * Constructor.
	 */
	KeysCriteria(Builder builder) {
		super(builder);
	}
	 ...
	 * Copy constructor.
	 */
	KeysCriteria(Builder builder, KeysCriteria criteria) {
