...
/**
 * FreeMarker-based XSL-FO Module Test.
 * @author Andres Rodriguez
 */
public class FreeMarkerFOPComponentTest {
	/**
	 * Start
	 */
	@Test
	public void start() throws Exception {
		final ModuleTester<FreeMarkerFOPModule> module = TestContext.empty().getModule(FreeMarkerFOPModule.class);
