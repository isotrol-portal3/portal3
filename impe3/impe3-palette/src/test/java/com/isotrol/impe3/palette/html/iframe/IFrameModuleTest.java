 ...
 */
public class IFrameModuleTest {
	private static TestEnvironment environment;
	private static ModuleTester<IFrameModule> tester;

	@BeforeClass
	public static void setUp() {
		environment = new TestEnvironmentBuilder().get();
		tester = environment.getModule(IFrameModule.class);
	}
	...
	public void start() {
		tester.fakeStart();
		tester.getComponent("simple").executeAndRenderHTML();
	}
