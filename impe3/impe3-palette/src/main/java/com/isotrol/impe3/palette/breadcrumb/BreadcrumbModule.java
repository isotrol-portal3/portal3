...
@Version("1.0")
public interface BreadcrumbModule extends WithFreeMarker, WithCategories, WithURIGenerator, Module {
	/** Manual component. */
	@Name("manual")
	ManualBreadcrumbComponent manual();

	/** Navigation component. */
	@Name("navigation")
	NavigationBreadcrumbComponent navigation();
	
	/** Content component. */
	@Name("content")
	ContentBreadcrumbComponent content();
	
	/** Module configuration. */
	void config(BreadcrumbConfig config);
}
