...
@Version("1.0")
/**
 * Device resolvers module.
 * @author Emilio Escobar Reyero
 * @uathor Andres Rodriguez
 */
public interface DeviceResolverModule extends Module {
	/** Deprecated. */
	@Name("headersResolver")
	DeviceResolver headersResolver();

	/** Width. */
	@Name("width")
	DeviceResolver width();
	...
	/** Configuration. */
	void config(DeviceResolverModuleConfig config);
}
