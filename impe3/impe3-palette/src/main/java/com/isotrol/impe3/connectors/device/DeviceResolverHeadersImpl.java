...
/**
 * Device resolver headers width size default implementation
 * @author Emilio Escobar Reyero
 * @author Andres Rodriguez
 */
@Deprecated
public class DeviceResolverHeadersImpl implements DeviceResolver {
	/** Constructor. */
	public DeviceResolverHeadersImpl() {
	}
