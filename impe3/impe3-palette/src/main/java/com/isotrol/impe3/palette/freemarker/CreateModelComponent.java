...
/**
 * Components that creates and export the default FreeMarker Template Model if no model has been injected.
 * @author Andres Rodriguez
 */
public final class CreateModelComponent implements Component {
	/** Request context. */
