...
@Version("1.0")
@SpringSimple
public interface TransformInPageModule extends Module {
	/** Content type navigation. */
	@Name("contentType.name")
	ContentTypeNavigationComponent contentType();

	/** Category navigation. */
	@Name("category.name")
	CategoryNavigationComponent category();

	/** Category navigation. */
	@Name("ancestorCategory.name")
	AncestorCategoryNavigationComponent ancestorCategory();
