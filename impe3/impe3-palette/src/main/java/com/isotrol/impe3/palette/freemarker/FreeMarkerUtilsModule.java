...
/**
 * FreeMarker Utilities Component Module.
 * @author Andres Rodriguez
 */
@SpringSimple
@Name("FreeMarker Utils")
@Copyright("Isotrol, SA. (GPL3)")
@Version("1.0")
public interface FreeMarkerUtilsModule extends Module {
	/** New Model. */
	@Name("New Model")
	NewModelComponent newModel();

	/** Create Model if needed. */
	@Name("Create Model if Needed")
	CreateModelComponent createModel();
}
