...
/**
 * Content reading from key functional component module.
...
@Version("1.0")
public interface FromKeyContentModule extends Module, WithContentRepository {

	/** Provided component. */
	@Name("component")
	FromKeyContentComponent component();
