...
/**
 * Base interface for freemarker-related configurations.
 * @author Andres Rodriguez
 */
@Bundle
public interface FreeMarkerConfiguration extends Configuration {
	@FileBundle
	@Optional
	@Name("bundle")
	FileId templateBundle();
	...
	/** Whether to use object wrapping. */
	@DefaultValue("false")
	@Name("wrap")
	boolean wrap();
}
