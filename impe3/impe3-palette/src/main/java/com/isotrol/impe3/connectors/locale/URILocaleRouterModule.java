...
/**
 * URI Locale Router Connector Module.
 * @author Andres Rodriguez Chamorro
 */
@Path("uri.xml")
@Name("Rutado de idioma por primer segmento de URI")
@Copyright("Isotrol, SA. (GPL3)")
@Version("1.0")
public interface URILocaleRouterModule extends Module {
	/** Provided service. */
	LocaleRouter service();

	/* Optional dependency. */
	// @Name("fallback")
	// void fallback(LocaleResolver fallback);

	/** Configuration. */
	void config(URILocaleRouterConfig config);
}
