...
/**
 * XML Content Listing Component Module.
...
@Version("1.0")
public interface ListingPageModule extends WithFreeMarker, Module {
	/** Provided component. */
	@Name("component")
	ListingPageComponent component();

	/** Module configuration. */
	void config(ListingPageModuleConfig config);
}
