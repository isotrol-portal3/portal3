...
import com.isotrol.impe3.api.support.WithActionExporterProvision;
import com.isotrol.impe3.api.support.WithURIGenerator;


/**
 * Session Locale Router Connector Module.
...
@Version("1.0")
public interface SessionLocaleActionModule extends Module, WithActionExporterProvision, WithURIGenerator {
	/** Locale setter action. */
	Object localeSetter();

	/** Configuration. */
	void config(SessionLocaleActionConfig config);
}
