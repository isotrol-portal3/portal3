...
@Version("1.0")
public interface XMLContentDetailModule extends WithFreeMarker, Module {
	/** Provided component. */
	@Name("component")
	XMLContentDetailComponent component();

	/** Module configuration. */
	void config(XMLContentDetailModuleConfig config);
}
