...
/**
 * XSLT-based XSL-FO Module.
 * @author Andres Rodriguez
 */
@Name("Generador de PDF con FOP y XSLT")
@Path("fop-xslt.xml")
@Copyright("Isotrol, SA. (GPL3)")
@Version("1.0")
public interface XSLTFOPModule extends WithFreeMarker, WithFopService, WithFileLoader, Module {
	/** Provided component. */
	XSLTFOPComponent component();

	/** Module configuration. */
	void config(FreeMarkerFOPModuleConfig config);
}
