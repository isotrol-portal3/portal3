...
/**
 * Model (content and listing) constructor module.
 * 
...
@Version("1.0")
@SpringSimple
public interface TemplateModelModule extends Module, WithFileLoader {

	@Name("content")
	ContentModelComponent content();

	@Name("listing")
	ListingModelComponent listing();

	void config(TemplateModelConfig config);
