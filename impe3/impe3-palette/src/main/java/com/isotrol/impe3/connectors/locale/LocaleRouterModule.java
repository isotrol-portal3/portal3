...
/**
 * Default Locale Router Module
 * @author Emilio Escobar Reyero
 */
@Path("locale-router.xml")
@Bundle
@Name("name")
@Description("desc")
@Copyright("Isotrol, SA. (GPL3)")
@Version("1.0")
public interface LocaleRouterModule extends Module {
	@Name("service")
	LocaleRouter service();
	
	@Name("locale.resolver")
	void localeResolver(LocaleResolver localeResolver);
	
	@Name("locale.generator")
	void localeURIGenerator(LocaleURIGenerator localeURIGenerator);
