...
@Version("1.0")
public interface HTMLModule extends WithFileLoader, Module {
	/** Style component. */
	@Name("style")
	...
	/** No visual HTML file component. */
	@Name("noVisualHtml")
	NoVisualHTMLComponent noVisualHtml();

	/** Module configuration. */
	void config(HTMLModuleConfig config);
}
