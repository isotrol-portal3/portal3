...
@Version("1.0")
public interface HttpClientModule extends Module{

	/** HttpClient service wrapper */
	HttpClientConnector service();
	
	/** Configuration. */
	void config(HttpClientConfig config);
}
