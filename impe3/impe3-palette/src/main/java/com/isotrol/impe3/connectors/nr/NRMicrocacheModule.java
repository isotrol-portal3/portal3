...
/**
 * A NodeRepository microcache.
 * @author Andres Rodriguez Chamorro
 */
@Name("Microcach\00e9 para un repositorio de nodos")
@Description("Modulo que incorpora un microcach\00e9 para un repositorio de nodos. No utilizarlo para aquellos que ya lo incorporen")
@Copyright("Isotrol, SA. (GPL3)")
@Version("1.0")
@Path("microcache.xml")
public interface NRMicrocacheModule extends Module {
	/** Provided service. */
	@Name("Servicio")
	NodeRepository service();

	/** Repository to cache. */
	@Name("Repositorio a cachear")
	void repository(NodeRepository repository);

	/** Configuration. */
	void config(NRMicrocacheConfig c);
