...
package com.isotrol.impe3.users.gui.data;


import java.util.Collection;
import java.util.Set;

import com.isotrol.impe3.pms.gui.common.data.model.DTOModelData;
...
public class PortalUserSelModelData extends DTOModelData<PortalUserSelDTO> {
	 ...
	 */
	public static final Set<String> PROPERTIES = propertySet(PROPERTY_NAME, PROPERTY_DISPLAY_NAME, PROPERTY_ACTIVE);
