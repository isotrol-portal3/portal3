...
/**
 * URI generator to be used for testing.
 * @author Andres Rodriguez
 */
class TestURIGenerator extends AbstractURIGenerator {
	TestURIGenerator(Portal portal) {
		super(portal, URIs.EXAMPLE_URI, URIs.EXAMPLE_URI);
	}
}
