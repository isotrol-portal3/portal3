...
/**
 * Manages the connectors with problems but is still usables
 * 
 * @author Manuel Ruiz
 * 
 */
public class WarningConnectorsManagement extends AConnectorsManagement {
	...
	protected void callGetConnectors(AsyncCallback<List<ModuleInstanceSelDTO>> callback) {
		getService().getConnectorsByCorrectness(Correctness.WARN, callback);
	}
