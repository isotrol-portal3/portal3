...
/**
 * Manegement the spacial pages
 * 
 * @author Manuel Ruiz
 *
 */
public class TemplatePagesManagement extends AbstractGridPagesManagement {
	 ...
	 */
	@Inject
	public TemplatePagesManagement() {}
	...
	protected final void tryGetPages() {
		getUtil().mask(getPmsMessages().mskTemplatePages());
		...
		AsyncCallback<List<Inherited<PageSelDTO>>> callback = new AsyncCallback<List<Inherited<PageSelDTO>>>() {
			public void onFailure(Throwable arg0) {
				...
				getErrorProcessor().processError(
					arg0, 
					getEmrPages(),
					getPmsMessages().msgErrorRetrieveTemplatePages());
			}
		...
		super.getPagesService().getTemplatePages(super.getPortalPagesLoc(), callback);
	}
