...
/**
 * Management of pages classified as {@link PageClass#CONTENT_TYPE}: Content Type listing Pages
 * associated to Categories.
 * 
 * @author Manuel Ruiz
 * 
 */
public class CategoryContentTypePagesManagement extends AbstractWithCategoryContentPageManagement {

	/**
	 * Constructor
	 */
	public CategoryContentTypePagesManagement() {}
