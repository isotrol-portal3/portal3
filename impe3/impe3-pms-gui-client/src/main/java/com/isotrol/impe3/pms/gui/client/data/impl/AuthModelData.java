 ...
 * @param <D>
 */
public class AuthModelData<D extends AbstractAuthDTO> extends DTOModelData<D> {
	 ...
	 */
	public static final Set<String> PROPERTIES = propertySet(PROPERTY_DISPLAY_NAME);
	
	/**
	 * @param dto
	 */
	public AuthModelData(D dto) {
		super(dto);
	}
