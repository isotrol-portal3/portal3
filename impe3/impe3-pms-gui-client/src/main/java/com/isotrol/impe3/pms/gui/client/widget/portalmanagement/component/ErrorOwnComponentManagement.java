 ...
 * 
 */
public class ErrorOwnComponentManagement extends AOwnComponentManagement {
	...
	protected void callGetComponents(String portalId, AsyncCallback<List<ModuleInstanceSelDTO>> callback) {
		getComponentsService().getComponentsByCorrectness(portalId, Correctness.ERROR, callback);
	}
