 ...
 *
 */
public class ContentTypeSelModelData extends AbstractDTOModelDataWithStateAndId<ContentTypeSelDTO> {
	...
	/**
	 * <b>Default name</b> property descriptor<br/>
	 */
	 ...
	 * @param dto
	 */
	public ContentTypeSelModelData(ContentTypeSelDTO dto) {
		super(dto);
	}
...
//		ContentTypeSelDTO dto = getDTO();
//		if(property.equals(PROPERTY_DESCRIPTION)) {
//			String old = dto.getDescription();
