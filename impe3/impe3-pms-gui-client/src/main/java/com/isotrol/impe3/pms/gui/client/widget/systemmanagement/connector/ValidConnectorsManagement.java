...
/**
 * Manages the valid Connectors.
 * 
 * @author Manuel Ruiz
 * 
 */
public class ValidConnectorsManagement extends AConnectorsManagement {
	...
	protected void callGetConnectors(AsyncCallback<List<ModuleInstanceSelDTO>> callback) {
		getService().getConnectorsByCorrectness(Correctness.OK, callback);
	}
