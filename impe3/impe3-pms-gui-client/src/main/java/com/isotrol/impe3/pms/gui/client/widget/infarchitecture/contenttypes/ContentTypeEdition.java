...
/**
 * Gui for a Content Type
 * 
 * @author Manuel Ruiz
 * 
 */
public class ContentTypeEdition extends AContentTypeEdition {

	/**
	 * Creates a new panel for Content Type edition.<br/>
	 * 
	 * @param model
	 */
	...
	protected String getHeadingText() {
		return getPmsMessages().headerContentTypeEdition() + ": " + getContentType().getDefaultName().getDisplayName();
	}
