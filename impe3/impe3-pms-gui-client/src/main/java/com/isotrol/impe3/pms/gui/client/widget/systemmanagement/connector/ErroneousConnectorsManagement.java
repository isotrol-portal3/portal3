...
/**
 * Manages the erroneous connectors.
 * 
 * @author Andrei Cojocaru
 * 
 */
public class ErroneousConnectorsManagement extends AConnectorsManagement {
	...
	protected void callGetConnectors(AsyncCallback<List<ModuleInstanceSelDTO>> callback) {
		getService().getConnectorsByCorrectness(Correctness.ERROR, callback);
	}
}
