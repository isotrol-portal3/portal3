...
/**
 * Value that represents the last publication record.
 * @author Andres Rodriguez
 */
@Embeddable
public class LastPublished implements Done {
	/** User. */
	 ...
	 * @param user User.
	 */
	public LastPublished(UserEntity user) {
		this.user = user;
	...
	public boolean equals(Object obj) {
		if (obj instanceof LastPublished) {
			final LastPublished c = (LastPublished) obj;
