 ...
 */
public final class ConfigurationObject extends AbstractIdentifiable {
	...
	private static Object[] logArgs(ConfigurationObject object, Object o) {
	...
	private static final Function<Item, ConfigurationTemplateItemDTO> item(final Context1 ctx,
		final ConfigurationObject object) {
	 ...
	 */
	static ConfigurationObject of(ConfigurationDefinition<?> definition, ConfigurationEntity entity) {
	...
	private static ConfigurationTemplateDTO create(ConfigurationDefinition<?> definition, Context1 ctx,
	...
	static ConfigurationTemplateDTO template(ConfigurationDefinition<?> definition, Context1 ctx) {
	...
	/** Exported files. */
	private final ImmutableMap<UUID, FileObject> files;
	...
	public ImmutableMap<UUID, FileObject> getFiles() {
		return files;
	}
	...
	private static final class Loader extends
		AbstractValueLoader<ConfigurationEntity, ConfigurationObject, ConfigurationDefinition<?>> {
		Loader() {
			super("Configuration");
		}

		@Override
		protected ConfigurationObject load(ConfigurationEntity entity, ConfigurationDefinition<?> definition) {
			return new ConfigurationObject(definition, entity);
		}
	}
