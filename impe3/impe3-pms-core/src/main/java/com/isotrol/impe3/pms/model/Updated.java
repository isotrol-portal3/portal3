...
/**
 * Value that represents the update record.
 * @author Andres Rodriguez
 */
@Embeddable
public class Updated implements Done {
	/** User. */
	 ...
	 * @param user User.
	 */
	public Updated(UserEntity user) {
		this.user = user;
	...
	public boolean equals(Object obj) {
		if (obj instanceof Updated) {
			final Updated u = (Updated) obj;
			return Objects.equal(user, u.user) && Objects.equal(timestamp, u.timestamp);
		}
		return false;
	}
}
