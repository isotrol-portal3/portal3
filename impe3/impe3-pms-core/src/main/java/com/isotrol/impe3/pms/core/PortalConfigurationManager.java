 ...
 * @author Enrique Diaz.
 */
public interface PortalConfigurationManager {
	/**
	 ...
	 */
	ConfigurationEntity create(PortalConfigurationDefinition<?> cd, Collection<ConfigurationItemDTO> configuration)
		throws PMSException;
	 ...
	 * @throws PMSException If an error occurs.
	 */
	ConfigurationEntity create(PortalConfigurationDefinition<?> cd, ConfigurationPB configuration) throws PMSException;
	 ...
	 * @throws PMSException If an error occurs.
	 */
	ConfigurationEntity update(PortalConfigurationDefinition<?> cd, ConfigurationEntity entity,
	 ...
	 * @throws PMSException If an error occurs.
	 */
	ConfigurationEntity update(PortalConfigurationDefinition<?> cd, ConfigurationEntity entity, ConfigurationPB configuration)
		throws PMSException;
	 ...
	 * @throws PMSException If an error occurs.
	 */
	ConfigurationEntity update(PortalConfigurationDefinition<?> cd, UUID id, Collection<ConfigurationItemDTO> configuration)
		throws PMSException;
	 ...
	 * @throws PMSException If an error occurs.
	 */
	ConfigurationEntity update(PortalConfigurationDefinition<?> cd, UUID id, ConfigurationPB configuration)
		throws PMSException;
