...
/**
 * RecommendationDTO mapper.
 * @author Emilio Escobar Reyero.
 */
public enum RecommendationDTOMapper implements Function<RecommendationEntity, RecommendationDTO> {
	/** Singleton instance. */
	INSTANCE;
	 ...
	 */
	public RecommendationDTO apply(RecommendationEntity entity) {
		...
		dto.setRecommended(entity.getRecommended().getId().toString());
		dto.setRecommender(entity.getRecommender().getId().toString());
