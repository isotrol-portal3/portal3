...
/**
 * DTO for membership selection.
 * @author Emilio Escobar Reyero
 */
public class MembershipSelDTO extends AbstractVersionedLongId {
	/** Serial UID*/
	private static final long serialVersionUID = 8012483818185203621L;
	...
	public MembershipSelDTO() {
	}

	/**
	 * Returns the community info.
	 * @return The community info.
	 */
	...
	/**
	 * Sets the community info.
	 * @param community The community info.
	 */
