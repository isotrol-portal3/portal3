...
import com.isotrol.impe3.users.connector.WithPortalUsersService;
...
@Bundle
@Name("name")
public interface LoginModule extends WithURIGenerator, WithPortalUsersService, Module {
	/** Login action. */
	Object login();
	...
	/** Is logged component. */
	@Name("logged")
	IsLoggedComponent logged();

	/** Configuration. */
	void config(LoginConfig config);
}
