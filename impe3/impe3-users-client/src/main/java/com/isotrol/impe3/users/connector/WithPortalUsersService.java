...
/**
 * Portal Users Service dependency.
 * @author Emilio Escobar Reyero
 * @author Andres Rodriguez Chamorro
 */
@Bundle
public interface WithPortalUsersService {
	/** User service. */
	@Name("portalUsersService")
	@Description("portalUsersService.desc")
	void portalUsersService(PortalUsersService service);
}
