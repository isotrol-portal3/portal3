 ...
 */
@Path("echo-module.xml")
@Name("Simple Message Echo Connector Module")
@Description("Simple Connector Module with a dependency example")
public interface EchoModule extends Module {
	/** Provided service. */
	@Name("Echo Service")
	MessageService echo();
