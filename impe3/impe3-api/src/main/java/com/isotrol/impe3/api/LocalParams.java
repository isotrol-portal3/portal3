...
/**
 * A collection of HTTP request local parameters.
 * @author Andres Rodriguez
 */
public interface LocalParams extends Parameters<Object> {
	/**
	 ...
	 */
	LocalParams subset(Set<String> included);
	
	/**
	 * Applies a set of changes. The resulting collection is the union of the current collection
	 * and the values specified in the argument map.
	 * @param changes Changes to apply.
	 * @return A new local parameters colletion.
	 */
	LocalParams apply(Map<String, Object> changes);
}
