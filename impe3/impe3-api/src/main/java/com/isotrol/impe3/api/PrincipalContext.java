...
public interface PrincipalContext {
	 ...
	 * @return The currently logged in principal or {@code null} if there isn`t any.
	 */
	Principal getPrincipal();

	/**
	 * Sets the currently logged in principal.
	 * @param principal The currently logged in principal.
	 */
	void login(Principal principal);

	/**
	 * Clears the currently logged in principal.
	 */
	void logout();
}
