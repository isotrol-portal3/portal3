 ...
 *            bound data type
 */
public abstract class ADataBoundLayoutContainer<T> extends LayoutContainer implements IDataBound<T> {
	 ...
	 */
	public ADataBoundLayoutContainer(T data) {
	 ...
	 */
	protected DataBoundSupport<T> getDataBoundSupport() {
