...
/**
 * Field Listener which validates the bound field when the configured event occurs.
 * 
 * @author Andrei Cojocaru
 *
 */
public class ValidatorListener implements Listener<FieldEvent> {
