...
import com.isotrol.impe3.oi.mappers.LogTableDTOMapper;
 ...
 */
@Component
public class OILogTableComponent extends AbstractOiService {
	...
	void insert(String item, String name, int task) throws ServiceException {
		...
		final OILogTableEntity entity = new OILogTableEntity();
