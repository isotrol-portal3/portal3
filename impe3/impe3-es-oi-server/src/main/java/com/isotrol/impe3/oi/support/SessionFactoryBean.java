 ...
 */
package com.isotrol.impe3.oi.support;
...
/**
 * Default configuration for the OI Server Session Factory.
...
public class SessionFactoryBean extends AnnotationSessionFactoryBean {
	...
	private static final String[] SCAN_PACKAGES = {InterviewEntity.class.getPackage().getName()};
