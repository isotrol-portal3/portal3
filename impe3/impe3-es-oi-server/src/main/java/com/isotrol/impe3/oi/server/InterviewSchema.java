 ...
 */
public final class InterviewSchema {

	private InterviewSchema() {
		throw new AssertionError();
	}
	
	/** Reserved schema name. */
	public static final String SCHEMA_NAME = "oi-inte-";
	...
	/** Interviewee */
	public static final String INTERVIEWEE = prefix("INTERVIEWEE");
	/** Author */
